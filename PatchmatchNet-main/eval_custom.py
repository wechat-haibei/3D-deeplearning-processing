...
parser.add_argument('--testpath',default='./data/scan1', help='testing data path')
...
parser.add_argument('--outdir', default='./outputs_custom/result', help='output dir')
